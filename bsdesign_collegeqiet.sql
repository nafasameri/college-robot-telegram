...
--
-- Host: localhost:3306
-- Generation Time: Feb 26, 2019 at 11:18 PM
...
CREATE TABLE `course` (
  ...
  `master` varchar(100) COLLATE utf8_persian_ci NOT NULL,
  `time` varchar(8) COLLATE utf8_persian_ci NOT NULL,
  `day` varchar(30) COLLATE utf8_persian_ci NOT NULL,
...
(2, 'دوره ICDL (مقدماتی و پیشرفته)', 1, 2000000, 'مهندس امید', '97/11/25', 'پنجشنبه و جمعه', 'http://college.qiet.ac.ir/%D9%81%D8%B1%D9%88%D8%B4%DA%AF%D8%A7%D9%87/%D8%AF%D9%88%D8%B1%D9%87-icdl-%D9%85%D9%82%D8%AF%D9%85%D8%A7%D8%AA%DB%8C-%D9%88-%D9%BE%DB%8C%D8%B4%D8%B1%D9%81%D8%AA%D9%87/'),
...
CREATE TABLE `state` (
  ...
  `management` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;
...
INSERT INTO `state` (`chat_id`, `mainstate`, `groupstate`, `coursestate`, `registerstate`, `management`) VALUES
(92838553, 0, 0, 0, 0, 0),
(107640701, 0, 0, 2, 1, 3769),
(108910053, 1, 0, 0, 0, 0),
(116245039, 0, 0, 10, 0, 3655),
(116879271, 0, 3, 4, 0, 0),
(189686765, 0, 0, 0, 0, 0),
(240316366, 0, 0, 1, 0, 0),
(246469730, 0, 0, 0, 0, 0),
...
(92838553, 'نفس', 'عامری', '+989226290160'),
(107640701, NULL, NULL, NULL),
(116245039, NULL, NULL, NULL),
(116879271, 'مسعود', 'ایمانی نیا', '09353612967'),
(446696678, NULL, NULL, NULL),
(480635885, 'امین', 'خسروی', '09353529940');
